 ...
 * the class path under this location: /{@value edu.ucsd.crbs.autodockjobgenerator.Constants#PANFISH_AUTO_DOCK_TEMPLATE}
 * @author churas
 */
public class PanfishAutoDockScriptCreatorImpl implements PanfishAutoDockScriptCreator {
    ...
    /**
     * Creates {@value edu.ucsd.crbs.autodockjobgenerator.Constants#PANFISH_AUTO_DOCK_SCRIPT} script
