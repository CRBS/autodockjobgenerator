...
import edu.ucsd.crbs.autodockjobgenerator.io.FileListGenerator;
import java.io.File;
...
public class FileListGeneratorImpl implements FileListGenerator {
     ...
     * is a directory this method returns a list of all files ending in {@value edu.ucsd.crbs.autodockjobgenerator.Constants#PDBQT_SUFFIX}
