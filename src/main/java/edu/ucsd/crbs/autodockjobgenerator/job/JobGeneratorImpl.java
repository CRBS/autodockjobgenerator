...
public class JobGeneratorImpl implements JobGenerator,Runnable{
    ...
    /**
     * This method creates the Auto Dock jobs.  The jobs are batched into bundles of: {@link edu.ucsd.crbs.autodockjobgenerator.Constants#SUB_JOBS_PER_JOB}
     ...
     * directory:<P/>
     * 
     * {@value edu.ucsd.crbs.autodockjobgenerator.Constants#INPUTS_DIR_NAME}/(task id)/ligands <BR/>
     * {@value edu.ucsd.crbs.autodockjobgenerator.Constants#INPUTS_DIR_NAME}/(task id)/receptors <BR/>
     * <P/>
     * 
     * 
